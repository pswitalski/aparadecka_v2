...
- Branch names must follow `<type>/<kebab-description>` (e.g. `feat/about-page`), where `<type>` is one of: feat, fix, docs, refactor, chore, ci, test, style, perf, build, release, hotfix. The long-lived branches `master`, `stage`, and `prod` are exempt. Enforced by the pre-push hook.
